...
namespace Cinch
{
    ...
    ///		         <local:CompletedAwareGoToStateCommandTrigger 
    ///		                IsBeingUsedAtRootLevel="True"
    ///                     Command="{Binding GoToStateCommand}">
    ///			            <local:CommandDrivenGoToStateAction TargetObject="{Binding ElementName=tabControl}"/>
    ///		            </local:CompletedAwareCommandTrigger>
    ///	         </i:Interaction.Triggers>
