...
namespace CinchCodeGen
{
    ...
    public class WPFUIVisualizerService : IUIVisualizerService
    {
        ...
        public WPFUIVisualizerService()
        {
            ...
            Register("PropertyListPopup", typeof(PropertyListPopup));
            Register("ReferencedAssembliesPopup", typeof(ReferencedAssembliesPopup));
            Register("StringEntryPopup", typeof(StringEntryPopup));
        }
        #endregion
